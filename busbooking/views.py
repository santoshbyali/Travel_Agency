...
def home(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'busbooking/signin.html')
...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            return render(request, 'busbooking/list.html', locals())
        else:
            context["error"] = "Sorry no buses availiable"
            return render(request, 'busbooking/findbus.html', context)
    else:
        return render(request, 'busbooking/findbus.html')
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.rem > int(seats_r):
                ...
                # book.save()
                return render(request, 'busbooking/bookings.html', locals())
            else:
...
def cancellings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'busbooking/error.html', context)
    else:
        return render(request, 'busbooking/findbus.html')
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'busbooking/booklist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'busbooking/thank.html')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'busbooking/signup.html', context)
    else:
        return render(request, 'busbooking/signup.html', context)
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            return render(request, 'busbooking/success.html', context)
            # return HttpResponseRedirect('success')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'busbooking/signin.html', context)
    else:
